...
<div class="w3-row">
    ...
    <div class="w3-col w3-half w3-padding">
        ...
        <textarea id="input" bind:value={input} class="w3-block" style="height: 100%" rows="15"></textarea>
    </div>

    <div class="w3-col w3-half w3-padding">
        <label for="output">CSV</label>
        <textarea id="output" bind:value={output} class="w3-block" style="height: 100%" rows="15" readonly></textarea>
    </div>
</div>
